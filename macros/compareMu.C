...
void compareMu(std::string filename, std::string hist1, std::string hist2)
{  
  ...
  Float_t bins[] = { 50, 54, 58, 62, 66, 70, 75, 77, 105, 110,
  ...
  std::string lbl[] = { "Z(#rightarrow #mu^{+}#mu^{-}) + b-jets",
