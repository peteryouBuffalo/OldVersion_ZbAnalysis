...
def write_condor_config(workDir, sampleType, name_output_dir, nJob, debug = False):
  ...
  f.write('make \n')
  if debug:
    f.write('./main -filelist sampleList_$1.txt -out output_$1.root -data ' + sampleType + ' -lastentry 10000 \n')
  else:
    f.write('./main -filelist sampleList_$1.txt -out output_$1.root -data ' + sampleType + ' \n')
...
#////////////////////////////////////////////////////////////////////
lines = open(dataSet_list).readlines()
...
for line in lines:
  ...
  data_name = line.split('/')[1] + '_' + line.split('/')[2]
  work_dir = 'condor_run_' + data_name + '_' + dir_affix
  if line.find("Run2016") != -1 or line.find("Run2017") != -1 or line.find("Run2018") != -1:
    sampleType = '1'
  else:
    sampleType = '0'
  ...
  #os.system('rm -r ' + dir_final_rootFile_scratch)
  #os.system('mkdir -p ' + dir_final_rootFile_scratch)
...
#####################################################
  if runMode == 0:
    ...
    write_condor_config(work_dir, sampleType, dir_final_rootFile, nJob, debug)
